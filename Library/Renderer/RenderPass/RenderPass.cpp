...
{
	RenderPass::RenderPass(const vk::PhysicalDevice& physicalDevice, const vk::Format& surfaceFormat, const vk::Device& device):
	...
	void RenderPass::initialize()
	{
		...
		vk::AttachmentDescription colorAttachment { vk::AttachmentDescriptionFlags(), m_surfaceFormat,
